...
class gapi
{
  ...
  /*Deprecated:const account_data_url = 'https://www.google.com/analytics/feeds/accounts/default';*/
  ...
  public function __call($name,$parameters)
  {
    try {
      ...
      $aggregate_metric_key =
         gapi::array_key_exists_nc($name,$this->report_aggregate_metrics);
      ...
      throw new Exception('No valid root parameter or aggregate metric called "' . 
        $name . '"');
    } catch (Exception $e) {
